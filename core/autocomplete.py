...
class AutoComplete:
    ...
    def train(self, corpus: str) -> bool:
        """
            ...
            Args
                corpus: List[str] - a list of strings containing words
                    ...
                    cleaned
            Return
                Bool - a dictionary of dictionaries,
                    mapping words to (words to counts)
        """
        ...
        for word in word_set:
            if word in word_map: # doing this check because of the last words in the corpus
        ...
        result = db_conn.CorpusGraph.bulk_write(bulk_write_operations)
        return result.acknowledged

        # print(bulk_write_operations)
